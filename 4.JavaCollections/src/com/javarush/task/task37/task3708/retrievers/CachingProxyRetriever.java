...
public class CachingProxyRetriever implements Retriever{
    public OriginalRetriever originalRetriever;
    public LRUCache lruCache = new LRUCache(8);
...
//        System.out.print("Proxy 20: object("+object+"("+id+")) == null ? : "+(object==null));
        if (object == null){
            object = originalRetriever.retrieve(id);
//            System.out.println("  -> return from BD id = "+id+" object = "+object);
...
5. Метод retrieve класса CachingProxyRetriever должен получать объект из хранилища с помощью метода retrieve объекта типа OriginalRetriever
